...
public class AABB {
    ...
    public AABB(Collider collider, Vector2 absPos) { this(collider.SIZE, absPos, collider.LAYER, collider.MASK); }
    ...
    public AABB setPos(Vector2 pos) { return new AABB(SIZE, pos, LAYER, MASK); }
