...
public final class TestingUtils {
  ...
  public static void spawnProcess(Class<?> mainClass, String... args) throws IOException {
    ...
    System.arraycopy(new String[] { javaPath, "-cp", System.getProperty("java.class.path"), mainClass.getTypeName(), },
        0, command, 0, 4);
    System.arraycopy(args, 0, command, 4, args.length);
    Process childProcess = new ProcessBuilder(command).inheritIO().start();
