 ...
 * Example Usage:
 <pre>
     Sound.init();
     Sound sound = new Sound("<a href='https://github.com/tedMcleod/javafx.sound.demo/raw/refs/heads/main/src/resources/smw_coin.wav' >smw_coin.wav"</a>);
     for(int i=0; i<10; i++) {
         sound.play();
         Thread.sleep(100);
     }
...
public class Sound implements Closeable {
    ...
    /**
     * Plays silence to load up Audio API classes.
     * Make sure to call this method before any Sound is instantiated.
     */
    ...
    public Sound(String resourcePath) {
        this(Sound.class.getClassLoader().getResource(resourcePath));
    }
